...
const Player = (props) => {
	...
	useEffect(() => {
		...
		api.GetPlayer(playerID).then((data) => {
			...
			api.GetPlayerStats(playerID, cancelToken.token, "regularSeasonStatRankings").then(
				(playerRanks) => {
				...
				<Row gutter={[16, 16]} justify="center">
					<Col>
						<Descriptions bordered title="Player" layout="vertical">
							...
							<Descriptions.Item label="Shoots">
						...
						<Col>
							{player.primaryPosition.code === "G" ? (
								<Descriptions bordered title="Stats" layout="vertical">
									...
									<Descriptions.Item label="Time On Ice">
										{ranks.timeOnIce} - {stats.timeOnIce}
									</Descriptions.Item>
									<Descriptions.Item label="Games">
										{ranks.games} - {stats.games}
									</Descriptions.Item>
									<Descriptions.Item label="Shots Against">
										{ranks.shotsAgainst} - {stats.shotsAgainst}
									</Descriptions.Item>
									<Descriptions.Item label="Goals Against">
										{ranks.goalsAgainst} - {stats.goalsAgainst}
									</Descriptions.Item>
									<Descriptions.Item label="Goals Against Average">
										{ranks.goalsAgainstAverage} - {stats.goalAgainstAverage}
									</Descriptions.Item>
									<Descriptions.Item label="Shutouts">
										{ranks.shutOuts} - {stats.shutouts}
									</Descriptions.Item>
									<Descriptions.Item label="Saves">
										{ranks.saves} - {stats.saves}
									</Descriptions.Item>
									<Descriptions.Item label="Save Percentage">
										{ranks.savePercentage} - {stats.savePercentage}
									</Descriptions.Item>
								</Descriptions>
							) : (
								<Descriptions bordered title="Stats" layout="vertical">
									...
									<Descriptions.Item label="Points">
										{ranks.rankPoints} - {stats.points}
									</Descriptions.Item>
									<Descriptions.Item label="Shot %">
										{ranks.rankShotPct} - {stats.shotPct}
									</Descriptions.Item>
									<Descriptions.Item label="Shots">
										{ranks.rankShots} - {stats.shots}
									</Descriptions.Item>
									<Descriptions.Item label="Goals">
										{ranks.rankGoals} - {stats.goals}
									</Descriptions.Item>
									<Descriptions.Item label="Assists">
										{ranks.rankAssists} - {stats.assists}
									</Descriptions.Item>
									<Descriptions.Item label="Power Play Goals">
										{ranks.rankPowerPlayGoals} - {stats.powerPlayGoals}
									</Descriptions.Item>
									<Descriptions.Item label="Power Play Points">
										{stats.powerPlayPoints}
									</Descriptions.Item>
									<Descriptions.Item label="Faceoff %">
										{stats.faceOffPct}
									</Descriptions.Item>
								</Descriptions>
							)}
